...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon("/home/dev/NetBeansProjects/EmployeeManagementSystem/src/main/java/com/mycompany/employeemanagementsystem/icons/add_employee.jpg");
        id15.setIcon(img);
